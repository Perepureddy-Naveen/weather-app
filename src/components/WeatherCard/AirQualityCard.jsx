  ...
  return (
    <motion.div
      ...
      style={{
        background: theme === 'dark' 
          ...
          : 'linear-gradient(135deg, rgba(255,255,255,0.95), rgba(238,242,255,0.9))',
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <FiWind 
            ...
            style={{
              ...
              filter: theme === 'dark' ? 'drop-shadow(0 0 12px rgba(96,165,250,0.4))' : 'none'
            }}
          />
          <h3 
            ...
            style={{
              ...
              textShadow: theme === 'dark' ? '0 2px 8px rgba(96,165,250,0.3)' : 'none'
            }}>
            Air Quality
          </h3>
        </div>
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            >
              <div className="text-2xl font-bold" style={{ color: theme === 'dark' ? '#ffffff' : '#111827' }}>
                {aqi}
              </div>
            </div>
          </div>
          <div className="flex flex-col items-start">
            ...
            <span 
              ...
              style={{
                color: theme === 'dark' ? '#a5b4fc' : '#6b7280'
              }}
            >
              Air Quality Index
            </span>
      ...
      <div 
        ...
        style={{
          background: theme === 'dark'
            ? aqi > 100 ? 'rgba(245,158,11,0.15)' : 'rgba(16,185,129,0.15)'
            : aqi > 100 ? 'rgba(245,158,11,0.08)' : 'rgba(16,185,129,0.08)',
          borderColor: theme === 'dark'
            ? aqi > 100 ? 'rgba(245,158,11,0.4)' : 'rgba(16,185,129,0.4)'
            : aqi > 100 ? 'rgba(245,158,11,0.3)' : 'rgba(16,185,129,0.3)',
          boxShadow: theme === 'dark' 
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <p 
              ...
              style={{
                color: theme === 'dark' ? 'rgba(255,255,255,0.8)' : 'var(--light-text-secondary)'
              }}>
              {aqi <= 50 && 'Air quality is excellent for outdoor activities'}
              {aqi > 50 && aqi <= 100 && 'Air quality is acceptable for most people'}
              {aqi > 100 && aqi <= 150 && 'Sensitive groups should limit outdoor exposure'}
              {aqi > 150 && aqi <= 200 && 'Everyone should limit outdoor activities'}
              {aqi > 200 && aqi <= 300 && 'Avoid outdoor activities. Wear a mask if outside'}
              {aqi > 300 && 'Hazardous! Stay indoors and avoid all outdoor activities'}
            </p>
            <motion.div
              animate={{ scale: [1, 1.1, 1] }}
            ...
            >
              ...
              <span 
                ...
                style={{
                  color: theme === 'dark' ? 'rgba(255,255,255,0.6)' : 'var(--light-text-muted)'
                }}
              >
                Air quality insight
              </span>
      ...
      {/* Pollutant Grid */}
      <div 
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-4"
        style={{
          display: 'grid',
        ...
        {pollutants.slice(0, 6).map((pollutant, index) => (
          ...
          >
            ...
            <div 
              ...
              style={{
                background: `linear-gradient(135deg, 
                  ${theme === 'dark' ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.15)'} 0%, 
                  ${theme === 'dark' ? 'rgba(255,255,255,0.02)' : 'rgba(255,255,255,0.05)'} 100%)`
              }}
            />
            
            {/* Content */}
            <div className="flex flex-col lg:flex-row items-center p-4 h-full gap-4 lg:gap-6">
              {/* Icon */}
              <div 
            ...
            <div 
              ...
              style={{
                background: `linear-gradient(135deg, 
                  ${theme === 'dark' ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.1)'} 0%, 
                  transparent 100%)`
              }}
            />
          </motion.div>
