...
const WeeklyForecast = () => {
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          theme === "dark" ? "rgba(255,255,255,0.06)" : "var(--light-bg-glass)",
      ...
      <div className="flex items-center space-x-2 mb-4">
        ...
        <h3
          className={`text-lg font-semibold ${
            theme === "dark" ? "text-white" : "var(--light-text-primary)"
          }`}
        >
          7-Day Forecast
        </h3>
        ...
        {forecast.forecastday.map((day, index) => {
          ...
          return (
            <motion.div
              ...
              className="p-3 rounded-lg cursor-pointer transition-all duration-200 weekly-forecast-card"
              style={{
                background:
                  theme === "dark"
                      ...
                      style={{
                        background:
                          rainChance > snowChance
                            ? "rgba(59, 130, 246, 0.2)"
                            : "rgba(6, 182, 212, 0.2)",
                        color: rainChance > snowChance ? "#93c5fd" : "#67e8f9",
                      }}
                    >
