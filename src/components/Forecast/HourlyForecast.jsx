...
const HourlyForecast = () => {
  ...
  const visibleHourlyData = hourlyData.slice(
    scrollIndex,
    scrollIndex + visibleHours
  );
  ...
  return (
    <motion.div
      ...
      className="rounded-xl p-4 hourly-forecast-card"
      style={{
        background:
          theme === "dark"
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <FiChevronLeft
              ...
              style={{
                color:
                  theme === "dark" ? "#9ca3af" : "var(--light-text-secondary)",
              }}
            />
          </motion.button>
      ...
      <div className="flex space-x-3 overflow-x-auto pb-4">
        {visibleHourlyData.map((hour, index) => (
          <motion.div
            ...
            className="flex-shrink-0 p-3 rounded-xl min-w-[120px]"
            style={{
              background:
                theme === "dark"
